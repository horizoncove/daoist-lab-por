    ...
    <main className="min-h-screen bg-[#121212] text-[#F8F4E3] overflow-hidden font-sans">
      ...
      <nav className="relative z-50 flex justify-between items-center px-8 py-10 md:px-20 max-w-7xl mx-auto">
        ...
        >
          ...
          <span className="text-xl tracking-[0.3em] font-light">DAOIST LAB</span>
        </motion.div>
        
        <div className="hidden md:flex gap-12 text-[10px] uppercase tracking-[0.2em] font-light text-[#757575]">
          <Link href="/rituals" className="hover:text-[#D4AF37] transition-colors">The Rituals</Link>
          <Link href="/talismans" className="hover:text-[#D4AF37] transition-colors">Smart Talismans</Link>
          <Link href="/verify/wudang_001" className="text-[#D4AF37]">Verify PoR</Link>
        </div>
      </nav>
      ...
      <footer className="py-20 text-center border-t border-white/5">
        <div className="text-[10px] text-[#757575] uppercase tracking-[0.5em] mb-4">The Daoist Lab &copy; 2026</div>
